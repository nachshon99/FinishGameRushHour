...
public class Levels extends Level{
   ...
   public Levels(int level)
    ...
    public void level3() {
        xCar = new Car(CX, 3, 2, Color.red);
        aCar = new Car(CY, 4, 2, Color.green);
        ...
        setCars(new Car[]{xCar, aCar, bCar, cCar, oTruck, pTruck});
        }
    ...
    public void level4() {
        ...
        setCars(new Car[]{xCar, aCar, bCar, oTruck, pTruck, qTruck, rTruck});
    }
    ...
    public void level5() {
        ...
        setCars(new Car[]{xCar, aCar, bCar,dCar,eCar,fCar,gCar, oTruck, pTruck, qTruck, rTruck});
        }
